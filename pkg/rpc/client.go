...
func (c *RPCClient) GetCurrentSlot(ctx context.Context) (int64, error) {
    // Create the RPC request for the 'getSlot' method
    body, err := c.rpcRequest(ctx, formatRPCRequest("getSlot", nil))
    if err != nil {
